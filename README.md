# SKILLS Realtalk — Perfect Score Screen
...
- **Mobile #3** — [Animated evaluation modules](https://www.figma.com/design/lIS4T2YIXbPusWcjAVBYTF/SKILLS-Realtalk-Design?node-id=507-1512) (`507:1512`) — three stacked cards with staggered animation
...
```bash
cd /Applications/Playground/star
